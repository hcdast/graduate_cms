<template>
  <div>
    ...
    <el-table-column align="center" width="180px" label="所属行政班">
      <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    getMessageToClassAll(){
        this.$confirm('此操作将全部驳回给班级, 是否继续?', '提示', {
    ...
    // 全部上报
    upToOfficeAll(){
        this.$confirm('此操作将全部上报给教务, 是否继续?', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(() => {
